...
<body>
    <div class="container py-4">
        ...
        <form action="<?= route_to('reservas.actualizar_reservation', $reservation['id']) ?>" method="post" id="editReservationForm">
            <?= csrf_field() ?>
                    ...
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <input type="datetime-local" name="reservation_date" class="form-control"
                                value="<?= old('reservation_date', date('Y-m-d\TH:i', strtotime($reservation['reservation_date']))) ?>" required>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <input type="text" name="items" class="form-control"
                                   value="<?= old('items', $reservation['items']) ?>" placeholder='["1","2"]'>
                        </div>
                    </div>
                </div>
            </div>
