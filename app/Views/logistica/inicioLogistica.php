    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-success">
        <div class="container">
            ...
            <span class="navbar-text ms-auto">
                <i class="fas fa-truck me-2"></i><?= esc($user['username']) ?>
            </span>
    ...
    <div class="container my-5">
        <div class="row">
            <div class="col-md-3">
                <div class="card">
                    <div class="card-header bg-success text-white">
                        <i class="fas fa-boxes me-2"></i>Menú Logística
                    </div>
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header bg-success text-white">
                        <i class="fas fa-tachometer-alt me-2"></i>Dashboard de Logística
                    </div>
                    <div class="card-body">
                        <h5 class="card-title">Bienvenido, <?= esc($user['username']) ?></h5>
                        <p class="card-text">Panel de control para el equipo de logística.</p>
