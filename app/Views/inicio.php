...
<body>
    ...
    <a href="<?= base_url('/logout') ?>" class="btn btn-logout">Vista cliente</a>
    <a href="<?= base_url('/inventory') ?>" class="btn btn-inventario">Inventario</a>
    <?php if (session('role') === 'administrador'): ?>
        <a href="<?= base_url('/admin/usuarios') ?>" class="btn btn-users">Usuarios</a>
    <?php endif; ?>
</div>
    </div>
